...
describe('processor', () => {
  it('returns safe for single number line', () => {
    expect(processLine('123')).toStrictEqual({
      line: '123',
      isSafeV1: true,
      isSafeV2: true,
    });
  ...
  it('returns safe for increasing line', () => {
    expect(processLine('1 2 4 7 8 10')).toStrictEqual({
      line: '1 2 4 7 8 10',
      isSafeV1: true,
      isSafeV2: true,
    });
  ...
  it('returns safe for decreasing line', () => {
    expect(processLine('10 9 7 4 2 0')).toStrictEqual({
      line: '10 9 7 4 2 0',
      isSafeV1: true,
      isSafeV2: true,
    });
  ...
  it('returns safe for decreasing line exceeding 3', () => {
    expect(processLine('10 6 5 4 2 0')).toStrictEqual({
      line: '10 6 5 4 2 0',
      isSafeV1: false,
      isSafeV2: true,
    });
  ...
  it('returns unsafe for repeating numbers in line', () => {
    expect(processLine('1 2 3 3 6 7')).toStrictEqual({
      line: '1 2 3 3 6 7',
      isSafeV1: false,
      isSafeV2: true,
    });
  ...
  it('returns unsafe for repeating numbers in line', () => {
    expect(processLine('86 87 88 91 91')).toStrictEqual({
      line: '86 87 88 91 91',
      isSafeV1: false,
      isSafeV2: true,
    });
  ...
  describe('provided examples', () => {
    ...
    it('returns safe for 7 6 4 2 1', () => {
      expect(processLine('7 6 4 2 1')).toStrictEqual({
        line: '7 6 4 2 1',
        isSafeV1: true,
        isSafeV2: true,
      });
    ...
    it('returns unsafe for 1 3 2 4 5', () => {
      expect(processLine('1 3 2 4 5')).toStrictEqual({
        line: '1 3 2 4 5',
        isSafeV1: false,
        isSafeV2: true,
      });
    ...
    it('returns unsafe for 8 6 4 4 1', () => {
      expect(processLine('8 6 4 4 1')).toStrictEqual({
        line: '8 6 4 4 1',
        isSafeV1: false,
        isSafeV2: true,
      });
    ...
    it('returns safe for 1 3 6 7 9', () => {
      expect(processLine('1 3 6 7 9')).toStrictEqual({
        line: '1 3 6 7 9',
        isSafeV1: true,
        isSafeV2: true,
      });
